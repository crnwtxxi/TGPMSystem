    ...
    <div class="teaupload_container">
        <el-card>
            ...
            <el-table :data="tableDataForm" border style="width: 100%;">
                ...
                <el-table-column prop="teano" label="工号" width="150"></el-table-column>
                <el-table-column prop="sex" label="性别" width="150"></el-table-column>
                <el-table-column prop="rank" label="职称" width="150"></el-table-column>
                <el-table-column prop="class" label="导师类别" width="150"></el-table-column>
                ...
                <el-table-column prop="direct" label="研究方向" width="200"></el-table-column>
            </el-table>
        </el-card>
