    ...
    <div class="teaupload_container">
        <el-card>
            ...
            <el-table :data="tableDataForm" border style="width: 100%;">
                ...
                <el-table-column prop="direct" label="研究方向" min-width="200"></el-table-column>
                <el-table-column prop="rank" label="职称" min-width="150"></el-table-column>
        ...
        <el-card style="margin-top: 20px;text-align: left;">
            ...
            <div class="upload">
                <el-upload
                    ...
                    <div class="el-upload__tip" slot="tip">只能上传.xlsx或.xls文件，且不超过10M</div>
                </el-upload>
            </div>
    ...
    methods: {
        ...
        uploadFile() {
            if (this.fileList.length == 0) {
                ...
                this.axios.post('/admin/teacher-upload',form,{
