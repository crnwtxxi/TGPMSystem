    ...
    <div class="stuupload_container">
        <el-card>
            ...
            <el-table :data="tableDataForm" border style="width: 100%;">
                ...
                <!-- <el-table-column prop="tutor" label="导师" width="150"></el-table-column> -->
                <el-table-column prop="profess" label="专业" width="200"></el-table-column>
                <el-table-column prop="degree" label="学位性质" width="150"></el-table-column>
